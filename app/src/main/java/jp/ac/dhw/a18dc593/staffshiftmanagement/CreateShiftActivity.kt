...
class CreateShiftActivity : FragmentActivity(), DatePickerDialog.OnDateSetListener, TimePickerDialog.OnTimeSetListener {

    companion object {
        private const val TAG = "CreateShiftActivity"
    }
    ...
    fun showDatePickerDialog(view: View) {
        val newFragment = CreateShiftDatePick()
    ...
    fun showTimePickerDialogForAttendTime(view: View) {
        ...
        val newFragment = CreateShiftTimePick()
